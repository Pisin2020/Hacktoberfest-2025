    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center">
          ...
          <p className="mt-2 text-gray-600">Sign in to your CodeAcademy account</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="text-center">
          <p className="text-gray-600">
            ...
            <Link to="/signup" className="text-primary-600 hover:text-primary-500 font-medium transition-colors duration-200">
              Sign up
            </Link>
          </p>
        </motion.div>
